...
public class BluetoothConnService {
    ...
    private static final UUID MY_UUID =
            UUID.fromString("F0927600-A2B4-4AD6-8428-C30CA1B3845E");
    ...
    /**
     * Constructor. Prepares a new WiFiDirectActivity session.
     * @param context  The UI Activity Context
     * @param handler  A Handler to send messages back to the UI Activity
     */
    public BluetoothConnService(Context context, Handler handler) {
        mAdapter = BluetoothAdapter.getDefaultAdapter();
        mState = STATE_NONE;
        mHandler = handler;
        if (D) Log.d(TAG, "BTTEST Pasok");
    }
    ...
    private synchronized void setState(int state) {
        ...
        mHandler.obtainMessage(HybridMANETDTN.BT_MESSAGE_STATE_CHANGE, state, -1).sendToTarget();
    }
    ...
    public synchronized void start() {
        ...
        if (D) Log.d(TAG, "BTTEST Starting thread");
    ...
    private void connectionFailed() {
        ...
        Message msg = mHandler.obtainMessage(HybridMANETDTN.BT_MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(HybridMANETDTN.TOAST, "Unable to connect device");
        msg.setData(bundle);
    ...
    private void connectionLost() {
        ...
        Message msg = mHandler.obtainMessage(HybridMANETDTN.BT_MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(HybridMANETDTN.TOAST, "Device connection was lost");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    ...
    private class AcceptThread extends Thread {
        ...
        public AcceptThread() {
            ...
            mmServerSocket = tmp;
            Log.d(TAG, "BTTEST: SUCCESSFULLY LISTENED");
        }
        ...
        public void run() {
            ...
            while (mState != STATE_CONNECTED) {
                try {
                    ...
                    Log.d(TAG, "BTTEST WAITING FOR CONNECTION");
                    socket = mmServerSocket.accept();
                    Log.d(TAG, "BTTEST ACCEPTED CONNECTION");
                    ...
                    synchronized (BluetoothConnService.this) {
                        switch (mState) {
                            ...
                            case STATE_CONNECTING:
                                ...
                                Log.d(TAG, "CONNNNNEEEEECCCCCTEEEED");
                                break;
                            case STATE_NONE:
    ...
    private class ConnectedThread extends Thread {
        ...
        public void write(byte[] buffer) {
            try {
                ...
                Log.d(TAG, "BTTEST SENT " + new String(buffer));
                // Share the sent message back to the UI Activity
                mHandler.obtainMessage(HybridMANETDTN.BT_MESSAGE_WRITE, -1, -1, buffer).sendToTarget();
            } catch (IOException e) {
